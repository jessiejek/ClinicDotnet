  ...
  template: `
    <div class="patient-edit-modal">
      <header class="patient-edit-modal__header">
        <div class="patient-edit-modal__title">
          <h3>Edit Patient</h3>
          <p>Update patient record details.</p>
        </div>
        <ion-button class="patient-edit-modal__close" fill="clear" type="button" [disabled]="isSaving" (click)="cancel()">
          <ion-icon slot="icon-only" [icon]="closeOutline"></ion-icon>
        </ion-button>
      </header>

      <ion-content class="patient-edit-modal__body" [scrollY]="true">
        <form class="patient-edit-modal__form" [formGroup]="form" novalidate (ngSubmit)="submit()">
          <section class="patient-edit-modal__section">
            <div class="section-heading">Personal Information</div>
            <div class="patient-edit-modal__grid">
      ...
      <footer class="patient-edit-modal__footer">
